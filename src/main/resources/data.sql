...
CREATE TABLE airsidedb.rt_transponder_status (transponder_status_id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,    epc VARCHAR(255) DEFAULT NULL,    company_id BIGINT DEFAULT NULL,    out_timestamp DATETIME(6) DEFAULT NULL,    in_timestamp DATETIME(6) DEFAULT NULL,    transponder_id BIGINT DEFAULT NULL,    transponder_status VARCHAR(255) DEFAULT NULL,    vehicle_id BIGINT DEFAULT NULL,    row_record_status VARCHAR(255) DEFAULT NULL,    timestamp DATETIME(6) DEFAULT NULL)  ENGINE=INNODB DEFAULT CHARSET=UTF8MB4 COLLATE = UTF8MB4_0900_AI_CI
