...
import com.ncs.airside.repository.V_PASSIVE_STATUS_REPO;
...
public class AntennaPassiveController {
    ...
    @Autowired
    private V_PASSIVE_STATUS_REPO v_passive_status_repo;
    ...
    public ResponseEntity  viewPassiveScan () {

        List<V_PASSIVE_STATUS> vPassiveStatusList = v_passive_status_repo.findAll();

        return ResponseEntity.ok().body(vPassiveStatusList);
    }
